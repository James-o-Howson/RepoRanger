...
export class RepositoriesClient {
    ...
    repositories_Delete(repositoryId: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Repositories/Delete?";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRepositories_Delete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRepositories_Delete(response_ as any);
                } catch (e) {
    ...
    protected processRepositories_Delete(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
